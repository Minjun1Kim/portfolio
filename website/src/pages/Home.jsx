            ...
            <section className={classes.home} id="home">
                ...
                <div className={classes.homeContent}>
                    ...
                    <div className={classes.socialMedia}>
                        <a href="https://www.linkedin.com/in/kimminjun/" target="_blank" rel="noreferrer">
                            <LinkedInIcon style={{color: '#0ef'}} />
                        </a>
                        <a href="https://github.com/Minjun1Kim" target="_blank" rel="noreferrer">
                            <GitHubIcon style={{color: '#0ef'}}/>
                        </a>
                        <a href="mailto:minjunn.kim@mail.utoronto.ca" target="_blank" rel="noreferrer">
