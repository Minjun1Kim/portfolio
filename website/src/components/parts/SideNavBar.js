...
function SideNavBar(props) {
    ...
    const { foldedView, handleSidebarToggle, selectedItem, handleItemClick } = props;
    ...
    return (
      ...
      >
        ...
        >
            ...
            <List>
              {[
                { text: "Home", icon: <DashboardIcon style={{backgroundColor: '#fff', floodColor: '#fff'}}/> },
                { text: "Resume", icon: <PictureAsPdfIcon style={{backgroundColor: '#fff'}} /> },
              ].map((item) => (
                <ListItem
                  key={item.text}
                  disablePadding
            ...
            <List>
              {[
                { text: "CSCB07", icon: <CodeIcon style={{backgroundColor: '#fff'}} /> },
                { text: "MATA29", icon: <FunctionsIcon style={{backgroundColor: '#fff'}} /> },
                { text: "Statistics", icon: <TextSnippetIcon style={{backgroundColor: '#fff'}} /> },
              ].map((item) => (
                <ListItem
                  key={item.text}
                  disablePadding
